...
# Set up variables
entity_id = "FCO027_FCOS_gov"
url = "http://data.gov.uk/dataset/spend-over-25-000-in-fco-services"
errors = 0
# Set up functions
...
for title_div in title_divs:
    ...
    for block in blocks:
        ...
        links_block = block.find_all('a', href=True)[1]['href']
